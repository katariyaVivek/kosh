...
// Build TOML config for Gateway (openai provider mode)
const buildGatewayConfig = (baseUrl, apiKey, model) => {
...
// Detect Gateway by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildGatewayConfig(baseUrl, apiKey || "sk_gateway", model);
